...
describe("Single attachment", () => {
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text /uploads/document.pdf placement Left end\`");
        let expectedResult = base.replace("to-replace", `<div class=""><ul class="" style=""><li class="" style=""><div class="" style=""><span class="" style="">/uploads/document.pdf</span></div><div class="" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Show attachment in new tab" class="" style="">Show</a><a href="/uploads/document.pdf" download aria-label="Download attachment" class="" style="">Download</a></div></li></ul></div>`);
...
describe("Multiple attachments", () => {
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text Document 1 placement Left end attachment /uploads/document2.pdf text Document 2 placement Left end\`");
        let expectedResult = base.replace("to-replace", `<div class=""><ul class="" style=""><li class="" style=""><div class="" style=""><span class="" style="">Document 1</span></div><div class="" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Show attachment in new tab" class="" style="">Show</a><a href="/uploads/document.pdf" download aria-label="Download attachment" class="" style="">Download</a></div></li><li class="" style=""><div class="" style=""><span class="" style="">Document 2</span></div><div class="" style=""><a href="/uploads/document2.pdf" target="_blank" rel="noopener noreferrer" aria-label="Show attachment in new tab" class="" style="">Show</a><a href="/uploads/document2.pdf" download aria-label="Download attachment" class="" style="">Download</a></div></li></ul></div>`);
