...
const processorWithCss = remark().use(plugin, {
    ...
    showLinkText: "Vis",
    showLinkAltTextSuffix: "i ny fane",
...
describe("Single attachment", () => {
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text Document.pdf placement Left end\`");
        let expectedResult = base.replace("to-replace", `<div class="w-full flex justify-start"><div class="border border-gray-200 rounded-md divide-y divide-gray-200 max-w-lg mb-3" style="list-style: none !important; margin-top: 0 !important; margin-bottom: 0 !important;"><div class="pr-4 py-3 flex items-center justify-between text-sm text-gray-400 focus-within:text-blue-600" style="content: none; position: static !important; margin-top: 0 !important; margin-bottom: 0 !important; padding-left: 0.75rem !important;"><div class="flex items-center max-w-32 md:max-w-max" style=""><svg focusable="false" aria-hidden="true" class="flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd" /></svg><span class="ml-2 truncate text-gray-800 max-w-xs" style="" title="Document.pdf">Document.pdf</span></div><div class="ml-3 inline-flex space-x-4" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Vis Document.pdf i ny fane" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Vis</a><a href="/uploads/document.pdf" download aria-label="Hent Document.pdf" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Hent</a></div></div></div></div>`);
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text Document.pdf placement Left end\`");
        let expectedResult = base.replace("to-replace", `<div class=""><ul class="" style=""><li class="" style=""><div class="" style=""><span class="" style="" title="Document.pdf">Document.pdf</span></div><div class="" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Show Document.pdf in new tab" class="" style="">Show</a><a href="/uploads/document.pdf" download aria-label="Download Document.pdf" class="" style="">Download</a></div></li></ul></div>`);
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text Document.pdf placement Center end\`");
        let expectedResult = base.replace("to-replace", `<div class="w-full flex justify-center"><div class="border border-gray-200 rounded-md divide-y divide-gray-200 max-w-lg mb-3" style="list-style: none !important; margin-top: 0 !important; margin-bottom: 0 !important;"><div class="pr-4 py-3 flex items-center justify-between text-sm text-gray-400 focus-within:text-blue-600" style="content: none; position: static !important; margin-top: 0 !important; margin-bottom: 0 !important; padding-left: 0.75rem !important;"><div class="flex items-center max-w-32 md:max-w-max" style=""><svg focusable="false" aria-hidden="true" class="flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd" /></svg><span class="ml-2 truncate text-gray-800 max-w-xs" style="" title="Document.pdf">Document.pdf</span></div><div class="ml-3 inline-flex space-x-4" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Vis Document.pdf i ny fane" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Vis</a><a href="/uploads/document.pdf" download aria-label="Hent Document.pdf" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Hent</a></div></div></div></div>`);
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text Document.pdf placement Right end\`");
        let expectedResult = base.replace("to-replace", `<div class="w-full flex justify-end"><div class="border border-gray-200 rounded-md divide-y divide-gray-200 max-w-lg mb-3" style="list-style: none !important; margin-top: 0 !important; margin-bottom: 0 !important;"><div class="pr-4 py-3 flex items-center justify-between text-sm text-gray-400 focus-within:text-blue-600" style="content: none; position: static !important; margin-top: 0 !important; margin-bottom: 0 !important; padding-left: 0.75rem !important;"><div class="flex items-center max-w-32 md:max-w-max" style=""><svg focusable="false" aria-hidden="true" class="flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd" /></svg><span class="ml-2 truncate text-gray-800 max-w-xs" style="" title="Document.pdf">Document.pdf</span></div><div class="ml-3 inline-flex space-x-4" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Vis Document.pdf i ny fane" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Vis</a><a href="/uploads/document.pdf" download aria-label="Hent Document.pdf" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Hent</a></div></div></div></div>`);
...
describe("Multiple attachments", () => {
    test("css classes are applied, when the css options have been provided", () =>
    {
        ...
        let expectedResult = base.replace("to-replace", `<div class="w-full flex justify-start"><div class="border border-gray-200 rounded-md divide-y divide-gray-200 max-w-lg mb-3" style="list-style: none !important; margin-top: 0 !important; margin-bottom: 0 !important;"><div class="pr-4 py-3 flex items-center justify-between text-sm text-gray-400 focus-within:text-blue-600" style="content: none; position: static !important; margin-top: 0 !important; margin-bottom: 0 !important; padding-left: 0.75rem !important;"><div class="flex items-center max-w-32 md:max-w-max" style=""><svg focusable="false" aria-hidden="true" class="flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd" /></svg><span class="ml-2 truncate text-gray-800 max-w-xs" style="" title="Document 1">Document 1</span></div><div class="ml-3 inline-flex space-x-4" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Vis Document 1 i ny fane" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Vis</a><a href="/uploads/document.pdf" download aria-label="Hent Document 1" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Hent</a></div></div><div class="pr-4 py-3 flex items-center justify-between text-sm text-gray-400 focus-within:text-blue-600" style="content: none; position: static !important; margin-top: 0 !important; margin-bottom: 0 !important; padding-left: 0.75rem !important;"><div class="flex items-center max-w-32 md:max-w-max" style=""><svg focusable="false" aria-hidden="true" class="flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8 4a3 3 0 00-3 3v4a5 5 0 0010 0V7a1 1 0 112 0v4a7 7 0 11-14 0V7a5 5 0 0110 0v4a3 3 0 11-6 0V7a1 1 0 012 0v4a1 1 0 102 0V7a3 3 0 00-3-3z" clip-rule="evenodd" /></svg><span class="ml-2 truncate text-gray-800 max-w-xs" style="" title="Document 2">Document 2</span></div><div class="ml-3 inline-flex space-x-4" style=""><a href="/uploads/document2.pdf" target="_blank" rel="noopener noreferrer" aria-label="Vis Document 2 i ny fane" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Vis</a><a href="/uploads/document2.pdf" download aria-label="Hent Document 2" class="font-medium text-blue-600 hover:text-blue-500 outline-none focus:underline" style="text-decoration: none;">Hent</a></div></div></div></div>`);
    ...
    {
        let inputString = base.replace("to-replace", "\`attachment /uploads/document.pdf text Document 1 placement Left end attachment /uploads/document2.pdf text Document 2 placement Left end\`");
        let expectedResult = base.replace("to-replace", `<div class=""><ul class="" style=""><li class="" style=""><div class="" style=""><span class="" style="" title="Document 1">Document 1</span></div><div class="" style=""><a href="/uploads/document.pdf" target="_blank" rel="noopener noreferrer" aria-label="Show Document 1 in new tab" class="" style="">Show</a><a href="/uploads/document.pdf" download aria-label="Download Document 1" class="" style="">Download</a></div></li><li class="" style=""><div class="" style=""><span class="" style="" title="Document 2">Document 2</span></div><div class="" style=""><a href="/uploads/document2.pdf" target="_blank" rel="noopener noreferrer" aria-label="Show Document 2 in new tab" class="" style="">Show</a><a href="/uploads/document2.pdf" download aria-label="Download Document 2" class="" style="">Download</a></div></li></ul></div>`);
